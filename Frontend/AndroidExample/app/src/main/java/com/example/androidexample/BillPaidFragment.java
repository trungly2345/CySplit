...
public class BillPaidFragment extends Fragment implements BillItemsStore.Listener {

    private BillItemsAdapter adapter;

    public BillPaidFragment() {}
    ...
    public void onItemsUpdated() {
        adapter.setItems(BillItemsStore.getInstance().getPaid());
    }
