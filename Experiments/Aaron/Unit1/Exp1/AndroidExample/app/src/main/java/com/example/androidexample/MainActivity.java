...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setSpan(new ForegroundColorSpan(Color.RED), 0, 2, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        messageText.setText(title);

        messageText.post(() -> {
            float textWidth = messageText.getPaint().measureText(text.substring(2));
            ...
            CharacterStyle gradientSpan = new CharacterStyle(){
                @Override
            ...
            title.setSpan(gradientSpan, 2, title.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            messageText.setText(title);
        });
    }
}